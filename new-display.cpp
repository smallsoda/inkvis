...
{
    std::cout << "ConnectorConverter::" << __func__ << std::endl;
...
{
    std::cout << "Display::" << __func__ << std::endl;
}
...
{
    std::cout << "Display2Colors::" << __func__ << std::endl;
}
...
Display4Colors::Display4Colors(std::shared_ptr<Connector> con)
    : Display(std::move(con))
{
    std::cout << "Display4Colors::" << __func__ << std::endl;
}
